...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    // Optimization - Added switch statement to determine pizza width based on size
    switch(size){
      case "1":
        newWidth = 25;
        break;
    ...
    // Optimization - created pizzas
    var pizzas = document.querySelectorAll(".randomPizzaContainer");

    // Optimization - For each pizza, set newWidth determined in the swith statement
...
// Optimization - added requestAnimationFrame on updatePositions
